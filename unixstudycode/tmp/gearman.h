...
/**
 * Get current socket write timeout value.
 *
 * @param[in] gearman Structure previously initialized with gearman_create() or
 *  gearman_clone().
 * @return Timeout in milliseconds to wait for I/O activity. A negative value
...
/**
 * Set socket write timeout for connections in a Gearman structure.
 *
 * @param[in] gearman Structure previously initialized with gearman_create() or
 *  gearman_clone().
 * @param[in] timeout Milliseconds to wait for I/O activity. A negative value
...
/**
 * Get current reconnect interval value, that will block the connection for a 
 * while when some errors occers.
 *
 * @param[in] gearman Structure previously initialized with gearman_create() or
 *  gearman_clone().
 * @return Interval in seconds to wait for reconnect. A negative/zero value
 *  means no interval.
 */
GEARMAN_API
...
/**
 * Set reconnect interval value  for connections in a Gearman structure.
 *
 * @param[in] gearman Structure previously initialized with gearman_create() or
 *  gearman_clone().
 * @param[in] interval seconds to wait for reconnect. A negative/zero value
 *  means interval.
 */
GEARMAN_API
void gearman_set_reconnect_interval(gearman_st *gearman, int connect_interval);
 ...
 * Wait for I/O on connections.
 *
 * @param[in] gearman_con_st Structure previously initialized in
 *  gearman_st.
 * @return Standard gearman return value.
 */
GEARMAN_API
...
compress_ret q_compress(const char* source, long source_len,
    char* dest, long* dest_len, 
    compress_type type);

compress_ret q_uncompress(const char* source, long source_len,
    char* dest, long* dest_len);

long q_compressBound(long source_len);
/** @} */
